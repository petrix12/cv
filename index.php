...
<head>
	<title>HySOffice: Herramientas y Soluciones Office - Ing. Pedro Bazó | Programador de Aplicaciones y Desarrollador Web</title>
		...
		<div class="form-12-content">
			<div class="container">
				<div class="grid grid-column-2 ">
					<?php include "partes/experiencia.php"; ?>
					<?php include "partes/certificados.php"; ?>
				</div>
			</div>
		</div>
	</section>
