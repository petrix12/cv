	...
	<section class="w3l-about-breadcrum">
		<div class="breadcrum-bg">
			<div class="container py-5">
				<p><a href="index.php">Inicio</a> &nbsp; / &nbsp; Formación</p>
			</div>
		</div>
	</section>
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-5 content-photo">
						<a href="#"><img src="assets/images/trayectoria/grado_ucv.jpg" class="img-fluid" alt="Foto de grado de Ingeniero Químico"></a>
					</div>
					<div class="col-lg-7 content-left mt-lg-0 mt-5 pl-lg-5">
						<h3>Formación Academica</h3>
						<p class="mb-0">
							<img src="assets/images/logos/ucv.png" class="img-fluid" alt="Logo de la UCV" width="45" height="45">
						...
						<p class="mb-0">
							<img src="assets/images/logos/eam.jpg" class="img-fluid" alt="Logo de la Escuela de Aviación Militar" width="45" height="45">
							<strong>1992. ESCUELA DE AVIACIÓN MILITAR.</strong> Maracay. Estado Aragua. Logro: Servicio Militar Obligatorio.
						</p>
						<p class="mb-0">
							<img src="assets/images/logos/escubafan.jpg" class="img-fluid" alt="Logo de la Escuela Básica de las Fuerzas Armadas Nacionales" width="45" height="45">
						...
						<p class="mb-0">
							<img src="assets/images/logos/csvp.jpg" class="img-fluid" alt="Logo del Colegio San Vicente de Paúl" width="45" height="45">
							<strong>1990. COLEGIO SAN VICENTE DE PAÚL.</strong> Maiquetía. Estado Vargas. Logro: Titulo de Bachiller en Ciencias.
						</p>
						<p class="mb-0">
							<img src="assets/images/logos/gn.jpg" class="img-fluid" alt="Logo de la Guardia Nacional de Venezuela" width="45" height="45">
		...
		<div class="container py-lg-3">
			...
			<div class="row mt-lg-5">
				...
				<div class="col-lg-4 col-md-6 col-sm-12">
					<div class="box-wrap">
						<div class="icon">
							<img src="assets/images/logos/codigofacilito.png" alt="Logo Códigofacilito" width="60" height="60">
						</div>
						<hr />
						<div class="alto">
							<h6><a href="descargas/certificados/2020IntroduccionProgramacion.pdf" target="_blank"><strong>Introducción a la Programación</strong></a></h6>
						</div>
						<hr />
						<p class="alto2">
							Códigofacilito.
				...
				<div class="col-lg-4 col-md-6 col-sm-12">
					<div class="box-wrap">
						...
						<hr />
						<div class="alto">
							<h6><a href="descargas/certificados/2020MarcaPersonal.pdf" target="_blank"><strong>Marca Personal</strong></a></h6>
						</div>
						<hr />
						<p class="alto2">
							Platzi.
			...
			<div class="row mt-lg-5">
				...
				<div class="col-lg-4 col-md-6 col-sm-12">
					<div class="box-wrap">
						<div class="icon">
							<img src="assets/images/logos/cpee.jpg" alt="Logo Capacitate para el empleo" width="60" height="60">
						</div>
						<hr />
						<div class="alto">
							<h6><a href="descargas/certificados/2020DesarrolladorBackEnd.pdf" target="_blank"><strong>Desarrollador Back-end</strong></a></h6>
						</div>
						<hr />
						<p class="alto2">
				...
				<div class="col-lg-4 col-md-6 col-sm-12">
					<div class="box-wrap">
						...
						<hr />
						<div class="alto">
							<h6><a href="descargas/certificados/2020CursoProfesionalDeJava.pdf" target="_blank"><strong>Curso Profesional de Java</strong></a></h6>
						</div>
						<hr />
						<p class="alto2">
							Códigofacilito.
			...
			<div class="row mt-lg-5">
				<div class="col-lg-4 col-md-6 col-sm-12">
					<div class="box-wrap">
						...
						<hr />
						<div class="alto">
							<h6><a href="descargas/certificados/2020CompetenciasDigitalesParaProfesionales.pdf" target="_blank"><strong>Competencias digitales para profesionales</strong></a></h6>
						</div>
						<hr />
						<p class="alto2">
				...
				<div class="col-lg-4 col-md-6 col-sm-12">
					<div class="box-wrap">
						...
						<hr />
						<div class="alto">
							<h6><a href="descargas/certificados/2020DesarrolladorFrontEnd.pdf" target="_blank"><strong>Desarrollador Front-end</strong></a></h6>
						</div>
						<hr />
						<p class="alto2">
							Capacitate para el empleo. Fundación Carlos Slim.
				...
				<div class="col-lg-4 col-md-6 col-sm-12">
					<div class="box-wrap">
						...
						<hr />
						<div class="alto">
							<h6><a href="descargas/certificados/2020ProgramadorOO.pdf" target="_blank"><strong>Programador (orientado a objetos)</strong></a></h6>
						</div>
						<hr />
						<p class="alto2">
							Capacitate para el empleo. Fundación Carlos Slim.
			...
			<div class="row mt-lg-5">
				<div class="col-lg-4 col-md-6 col-sm-12">
					<div class="box-wrap">
						...
						<hr />
						<div class="alto">
							<h6><a href="descargas/certificados/2020TransformacionDigitalParaElEmpleo.pdf" target="_blank"><strong>Transformacion digital para el empleo</strong></a></h6>
						</div>
						<hr />
						<p class="alto2">
				...
				<div class="col-lg-4 col-md-6 col-sm-12">
					<div class="box-wrap">
						...
						<hr />
						<div class="alto">
							<h6><a href="descargas/certificados/2020IntroduccionAlDesarrolloWebII.pdf" target="_blank"><strong>Introducción al Desarrollo Web II</strong></a></h6>
						</div>
						<hr />
						<p class="alto2">
				...
				<div class="col-lg-4 col-md-6 col-sm-12">
					<div class="box-wrap">
						...
						<hr />
						<div class="alto">
							<h6><a href="descargas/certificados/2020DesarrolloDeAppsMoviles.pdf" target="_blank"><strong>Desarrollo de Apps Móviles</strong></a></h6>
						</div>
						<hr />
						<p class="alto2">
			...
			<div class="row mt-lg-5">
				<div class="col-lg-4 col-md-6 col-sm-12">
					<div class="box-wrap">
						...
						<hr />
						<div class="alto">
							<h6><a href="descargas/certificados/2020CuradorDeDatos.pdf" target="_blank"><strong>Curador de datos</strong></a></h6>
						</div>
						<hr />
						<p class="alto2">
							Capacitate para el empleo. Fundación Carlos Slim.
				...
				<div class="col-lg-4 col-md-6 col-sm-12">
					<div class="box-wrap">
						...
						<hr />
						<div class="alto">
							<h6><a href="descargas/certificados/2020FundamentosDeMarketingDigital.pdf" target="_blank"><strong>Fundamentos de Marketing Digital</strong></a></h6>
						</div>
						<hr />
						<p class="alto2">
				...
				<div class="col-lg-4 col-md-6 col-sm-12">
					<div class="box-wrap">
						...
						<hr />
						<div class="alto">
							<h6><a href="descargas/certificados/2020IntroduccionAlDesarrolloWebI.pdf" target="_blank"><strong>Introducción al Desarrollo Web I</strong></a></h6>
						</div>
						<hr />
						<p class="alto2">
							Google Actívate. Instituto de Economía Internacional.
			...
			<div class="row mt-lg-5">
				<div class="col-lg-4 col-md-6 col-sm-12">
					<div class="box-wrap">
						<div class="icon">
							<img src="assets/images/logos/seaport.png" alt="Logo de Seaport Agencies" width="60" height="60">
						</div>
						<hr />
						<div class="alto">
				...
				<div class="col-lg-4 col-md-6 col-sm-12">
					<div class="box-wrap">
						<div class="icon">
							<img src="assets/images/logos/inested.jpg" alt="Logo de Grupo Inested" width="60" height="60">
						</div>
						<hr />
						<div class="alto">
				...
				<div class="col-lg-4 col-md-6 col-sm-12">
					<div class="box-wrap">
						<div class="icon">
							<img src="assets/images/logos/pdvsa.png" alt="Logo de PDVSA" width="60" height="60">
						</div>
						<hr />
						<div class="alto">
			...
			<div class="row mt-lg-5">
				...
				<div class="col-lg-4 col-md-6 col-sm-12">
					<div class="box-wrap">
						<div class="icon">
							<img src="assets/images/logos/gerencia_activa.png" alt="Logo de Gerencia Activa" width="60" height="60">
						</div>
						<hr />
						<div class="alto">
				...
				<div class="col-lg-4 col-md-6 col-sm-12">
					<div class="box-wrap">
						<div class="icon">
							<img src="assets/images/logos/mauritia.png" alt="Logo de Mauritia, Consultores C.A." width="60" height="60">
						</div>
						<hr />
						<div class="alto">
			...
			<div class="row mt-lg-5">
				...
				<div class="col-lg-4 col-md-6 col-sm-12">
					<div class="box-wrap">
						<div class="icon">
							<img src="assets/images/logos/proynca.png" alt="Logo de PROYNCA" width="60" height="60">
						</div>
						<hr />
						<div class="alto">
			...
			<div class="row mt-lg-5">
				<div class="col-lg-4 col-md-6 col-sm-12">
					<div class="box-wrap">
						<div class="icon">
							<img src="assets/images/logos/eni.png" alt="Logo de ENI" width="60" height="60">
						</div>
						<hr />
						<div class="alto">
			...
			<div class="row mt-lg-5">
				...
				<div class="col-lg-4 col-md-6 col-sm-12">
					<div class="box-wrap">
						<div class="icon">
							<img src="assets/images/logos/ucv.png" alt="Logo de la Universidad Central de Venezuela" width="60" height="60">
						</div>
						<hr />
						<div class="alto">
				...
				<div class="col-lg-4 col-md-6 col-sm-12">
					<div class="box-wrap">
						<div class="icon">
							<img src="assets/images/logos/generico.png" alt="Logo genérico" width="60" height="60">
						</div>
						<hr />
						<div class="alto">
				...
				<div class="grids-forms">
					<div class="main-midd">
						<h4 class="global-title mx-auto">
							<img src="assets/images/logos/ucv.png" alt="" width="50" height="50">
							Trabajo Especial de grado para optar por el título de Ingeniero Químico
							<img src="assets/images/logos/ing_ucv.jpg" alt="" width="50" height="50">
						</h4>
						<hr />
						<p><b><a href="descargas/tesis_ing/2002TesisDeGradoIngQuim.pdf" target="_blank">Desarrollo de un programa modular para el ajuste de datos experimentales con modelos no lineales</a></b></p>
						<hr />
						<p>
							En este trabajo se desarrolló una
							<a href="descargas/tesis_ing/2020ManualOptiMiz.pdf" target="_blank">aplicación</a>
						...
						<p><img src="assets/images/logos/jifi.png" alt="" width="70" height="70"></p>
